...
def load_vgg(sess, vgg_path):
    ...
    #here the pretrained model will be loaded into tensorflow
    #as described in lesson 10, "FCN-8 - Encoder"
    #as described in lesson 11, "Reusing The Graph"
    #as described in walkthrough video
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # TODO: Implement function
    #as described in lesson 10 "FCN-8 - Decoder"
    #as described in the walkthrough video
    ...
    #Skip Connections
    comb1 = l4_conv_1x1 + l7_output

    #Upsampling
    comb1_output = tf.layers.conv2d_transpose(comb1, num_classes, 4, 2, padding='same',
                                kernel_initializer=tf.truncated_normal_initializer(stddev=0.01),
                                kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    #Skip Connections
    comb2 = l3_conv_1x1 + comb1_output

    #Upsampling
    comb2_output = tf.layers.conv2d_transpose(comb2, num_classes, 16, strides=(8,8), padding='same',
                                kernel_initializer=tf.truncated_normal_initializer(stddev=0.01),
                                kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    #as described in lesson 10 "FCN-8 - Classification & Loss"
    #as described in the walkthrough video
    ...
    for epoch in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            if (len(image) == batch_size):
            	#here is where the training is happening
...
def run():
    ...
    with tf.Session() as sess:
        ...
        print('build optimize operation')
